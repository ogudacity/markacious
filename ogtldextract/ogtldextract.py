...
class TLDExtract(object):
    ...
    def _get_tld_extractor(self):
        ...
        try:
            ...
            debugp("error reading TLD cache file %s: %s", cached_file, ioe)
        ...
        debugp("computed TLDs: [%s, ...]", ', '.join(list(tlds)[:10]))
#        if LOG.isEnabledFor(logging.DEBUG):
	if True:
        ...
        try:
            ...
            debugp("unable to cache TLDs in file %s: %s", cached_file, e)
